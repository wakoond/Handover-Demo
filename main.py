...
if __name__ == '__main__':
    ...
    frame = wx.Frame( None, wx.ID_ANY, 'WxPython and Matplotlib', size=(800,800) )

    gs = wx.GridSizer(2,3,5,5)
    frame.SetSizer(gs)

    panel = DemoPlotPanel( frame, points, clrs )
    gs.Add(panel, 0, wx.ALIGN_CENTER)
    gs.Add(wx.StaticText(frame, wx.ID_ANY, ':)'), 0, wx.EXPAND)
    panel2 = DemoPlotPanel( frame, points, clrs )
    gs.Add(panel2, 0, wx.ALIGN_CENTER)
    gs.Fit(frame)
